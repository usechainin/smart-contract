...
async function main() {
  ...
  const schemaBigInt = "75225182269462802158623086507070466790";

  const type = "Membership";
  const schemaUrl = "ipfs://QmfUycCFuSkdeUMdgYPTPH29KMhw6u7jFThoa93YbHacko";
  // merklized path to field in the W3C credential according to JSONLD  schema e.g. birthday in the KYCAgeCredential under the url "https://raw.githubusercontent.com/iden3/claim-schema-vocab/main/schemas/json-ld/kyc-v3.json-ld"
  const schemaClaimPathKey =
    "9248341519633598156347052793435598807876172677885090717321504132602979947036";
  ...
  const ProofOfMembershipVerifierAddress =
    "0x8971AD43eb2972Bf4a894aE77fe8e3c8362024D6";

  let erc20Verifier = await hre.ethers.getContractAt(
    "ProofOfMembershipVerifier",
    ProofOfMembershipVerifierAddress
  );
  ...
  const invokeRequestMetadata = {
    ...
    body: {
      ...
      transaction_data: {
        contract_address: ProofOfMembershipVerifierAddress,
        method_id: "b68967e2",
        chain_id: 80001,
